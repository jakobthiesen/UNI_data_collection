...
# Replace NaN std values if only one sample somehow exists
...
# -----------------------------
model.save_model("color_classifier_weighted_uncertainty.json")
...
print("Saved model to color_classifier_weighted_uncertainty.json")
...
plt.title("Confusion Matrix - Weighted Uncertainty Color Classifier")
plt.tight_layout()
plt.show()
...
plt.title("Feature Importance - Weighted Uncertainty Color Classifier")
plt.tight_layout()
plt.show()
